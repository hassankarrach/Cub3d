...
SRCS = $(LIBFT_SRCS) $(addprefix ./src/, cub3d.c parser.c cleanup.c utils.c raycasting.c init.c ray_facing_directions.c window.c player.c init_player.c renderer.c utils_raycasting.c events_handling.c draw_3d.c floor_casting.c)
# ==================
