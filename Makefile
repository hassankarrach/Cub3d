...
SRCS = $(LIBFT_SRCS) $(SCENES_SRC) $(addprefix ./src/, minimap.c sound_utils.c cub3d.c parser.c cleanup.c utils.c raycasting.c init.c ray_facing_directions.c window.c player.c init_player.c renderer.c utils_raycasting.c events_handling.c draw_3d.c floor_casting.c sprite.c render_door.c)
# ==================
